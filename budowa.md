...
<div class="flex justify-center items-center w-full min-h-screen p-2">
  <div class="w-full max-w-[800px] px-4">
    <div class="grid grid-rows-3 justify-items-center gap-4">
      ...
      <button class="text-amber-50 w-auto px-6 red-yellow-button py-1 sm:px-10 md:px-16 sm:py-4 cursor-pointer rounded-full orangeShadow font-medium"
